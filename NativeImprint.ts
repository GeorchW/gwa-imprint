...
import { CaptchaProtectedData, solveCaptcha } from './captchaLogic';
 ...
 */
export function createImprintElement(): HTMLDivElement {
    ...
    captchaElement.innerHTML = "<h3>Are you a robot?</h3>"
    ...
    question.innerText = captchaData.question;
